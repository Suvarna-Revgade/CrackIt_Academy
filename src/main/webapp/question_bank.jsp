...
<%@ page import="com.DB.DownloadFileQueBank" %>
<!DOCTYPE html>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Question Bank</h1>
                    <a href="" class="h5 text-white">Student Corner</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Question Bank</a>
                </div>
            </div>
        </div>
    </div>
    <!-- Navbar End -->
<center><h1 style=color:rgb(0,0,0);>DOWNLOAD question Bank</h1></center>
 
    <!-- <div class=" prevque">
    
    <center><h1 style=color:blue;>Question bank</h1></center><br>
    <hr>
        <div>
            <i class=" far fa-newspaper" style="color:	blue"></i>

           <a href="#"> Rajyaseva Main 2018 - GS-3</a>
       ...
       <hr>
        ...
        <div>
           ...
           <a href="#"> Question bank economi</a>
        ...
        <div>
           ...
           <a href="#"> Question bank economi2</a>
...
<div class=" prevque">
    ...
    <center><h1 style=color:blue;>Question back  for UPSE</h1></center><br>
    <hr>
        <div>
            <i class=" far fa-newspaper" style="color:	blue"></i>

           <a href="#"> Question bank economi9</a>
        ...
        <div>
           ...
           <a href="#"> Question bank economi1</a>
        </div>
       <hr>
        ...
        <div>
           ...
           <a href="#"> Question bank economi	2</a>
    ...
    <!-- Full Screen Search End -->
     ...
     <div class=" prevque">
      <center><h1 style=color:blue;> MPSE</h1></center><br>
 <table id="tablestyle" border="1">
        ...
        <tbody>
            <% 
            DownloadFileQueBank fDAO = new DownloadFileQueBank();
