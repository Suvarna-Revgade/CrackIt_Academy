<%@ page import="java.util.List" %>
	...
	<%@ page import="com.DB.DownloadFileClassQuePaper" %>
...
<!-- Spinner Start -->
                ...
                <div class="navbar-nav ms-auto py-0">
                   ...
                   <a href="pginfo.jsp" class="nav-item nav-link">PG Info</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="price.html" class="dropdown-item">Upcoming Exam</a>
                            <a href="feature.html" class="dropdown-item">Exam Timetable</a>
                            <a href="team.html" class="dropdown-item">Exam Form Dates</a>
                            <a href="testimonial.html" class="dropdown-item">Exam Results</a>
                            <a href="quote.html" class="dropdown-item">Cut-Offs</a>
                            <a href="quote.html" class="dropdown-item">Exam Notices</a>
                        </div>
                    </div>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="BookReading.html" class="nav-item nav-link">Reading Room</a>
                            
                        </div>
                    </div>
                    
                     <a href="ground.html" class="dropdown-item">Ground </a>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Class Question Paper</h1>
                    <a href="" class="h5 text-white">Student Corner</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="classquepaper.html" class="h5 text-white">Class Question Paper</a>
                </div>
            </div>
        </div>
    </div>
   ...
   <center><h1 style=color:black;>Crackit Academy Previous Year Question Papers</h1></center>

 <p style=color:black;	>These papers serve as valuable resources for students to comprehend the exam pattern, marking scheme, and the types of questions that may be asked. In this article, we will delve into the significance of the previous year's question papers and provide a comprehensive list of question papers.


 </p>
   <!--  <div class=" prevque">
    
    <center><h1 style=color:blue;>Download Class Question papers  for MPSE</h1></center><br>
    <hr>
        <div>
            <i class=" far fa-newspaper" style="color:	blue"></i>

          Question Paper 2019   <a href="#">  Download </a>
        ...
        <div>
            ...
            <a href="#"> Question Paper 2020</a>
        </div>
        <hr>
        <div>
            <i class=" far fa-newspaper" style="color:blue"></i>

           <a href="#"> Question Paper 2021</a>
        </div>
       <hr>
...
<div class=" prevque">
    ...
    <center><h1 style=color:blue;>Download Class Question papers  for UPSE</h1></center><br>
    <hr>
        <div>
            <i class=" far fa-newspaper" style="color:	blue"></i>

           <a href="#"> Question Paper 2019</a>
...
<div class=" prevque">
      <center><h1 style=color:blue;> Download Class Que Paper For MPSE And UPSC</h1></center><br>
 <table id="tablestyle" border="1">
        ...
        <tbody>
            <% 
            DownloadFileClassQuePaper fDAO = new DownloadFileClassQuePaper();
                List<file> Files = fDAO.getAllNotesFiles();
                for (file f : Files) {
            %>
            <tr>
                <td><%= f.getId() %></td>
                    ...
                    <div class="row gx-5">
                        ...
                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                            ...
                            <div class="link-animated d-flex flex-column justify-content-start">
                                ...
                                <a class="text-light mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Student Corner</a>
                                <a class="text-light mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Exam Section</a>
                                <a class="text-light mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Fee Structure</a>
            ...
            <div class="row justify-content-end">
                <div class="col-lg-8 col-md-6">
                    <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                        <p class="mb-0">&copy; <a class="text-white border-bottom" href="#">CrackIt Academy</a>. All Rights Reserved. 
						
						<!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
						Designed by <a class="text-white border-bottom" href="https://htmlcodex.com">telphatech LLP </a></p>
